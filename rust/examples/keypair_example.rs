...
fn main() {
    ...
    println!("   Private Key Size: {} bytes", keypair.private_key().to_bytes().len());
    ...
    println!("   Derivation is Deterministic: {}", public_key1 == public_key2);
    println!();
    ...
    println!("   KeyPair Private:  {}", keypair_from_private.private_key().to_hex());
    println!("   Keys Match: {}", private_key == *keypair_from_private.private_key());
    println!();
    ...
    println!("   Private Key Restored: {}", private_restored == *keypair.private_key());
    println!("   Public Key Restored:  {}", public_restored == *keypair.public_key());
    println!();
    ...
    println!("   Zero key derivation consistent: {}", zero_public == zero_public2);
    println!();
    ...
    println!("   Original Private:  {}", original_keypair.private_key().to_hex());
    println!("   Recovered Private: {}", recovered_private.to_hex());
    println!("   Original Public:   {}", original_keypair.public_key().to_hex());
    println!("   Recovered Public:  {}", recovered_public.to_hex());
    println!("   Private Key Recovery: {}", *original_keypair.private_key() == recovered_private);
    println!("   Public Key Recovery:  {}", *original_keypair.public_key() == recovered_public);
    println!();
